        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinioObjectKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PatientId = table.Column<int>(type: "integer", nullable: false),
                    EHRSystem = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    ExternalId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    IdentifierType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "DoctorId", "Email", "FirstName", "IsActive", "LastLoginAt", "LastName", "PasswordHash", "PatientId", "Role", "UpdatedAt", "Username" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "admin@hospital.com", "System", true, null, "Administrator", "$2a$11$QeJ8p9Qw1Qw1Qw1Qw1Qw1uQw1Qw1Qw1Qw1Qw1Qw1Qw1Qw1Qw1Qw1Qw", null, "Admin", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_AppointmentDate",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ChannelType",
                table: "Notifications",
                column: "ChannelType");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ChannelType_Status",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientIdentifiers_EHRSystem_ExternalId",
                table: "PatientIdentifiers",
                columns: new[] { "EHRSystem", "ExternalId" });
